...
The goal of regexcite.sc is to provide a new take on regular
expressions.  
...
You can install the development version of regexcite.sc from
[GitHub](https://github.com/) with:

``` r
# install.packages("pak")
pak::pak("cs-uche/regexcite.sc")
```
